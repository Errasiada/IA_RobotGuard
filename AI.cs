...
public class AI : MonoBehaviour
{
    ...
    Vector3 lastKnownPositionOfPlayer;
    bool fleeStatus;
    ...
    public void TakeCover()
    {
        ...
        lastKnownPositionOfPlayer = player.transform.position;
        agent.SetDestination(dest);
        Task.current.Succeed();
    ...
    [Task]
    public void SetTargetDestinationToLastPlayerPosition()
    {
        agent.SetDestination(lastKnownPositionOfPlayer);
        Task.current.Succeed();
    }

    [Task]
    public bool SetFleeStatus(bool status)
    {
        fleeStatus = status;
        return fleeStatus;
    }
